...
path.append('C:/Users/Administrator/Desktop/keras-mobilenet-master/keras_mobilenet')
import mobilenet
...
##    model = MobileNet(input_tensor = None,input_shape = (4,10,10),
##                      alpha = 1,shallow = True,classes = 3)
##    model = _create_dpn(nb_classes = 3,input_shape = (4,10,10),
##                          include_top = True,initial_conv_filters = 32,
##                          filter_increment = [16,32,64,128],
##                          depth = [2,2,2,2],cardinality = 1,width = 3,
##                          pooling = None)
